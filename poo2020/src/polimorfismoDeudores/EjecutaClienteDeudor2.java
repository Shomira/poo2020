        ...
        while(opcion <= 4){
            ...
            switch (opcion){
                case 1:
                    ...
                    PrestamoAuto2 Pa = new PrestamoAuto2(numCu,numCli,nombre,capPrest,plazoInv);
                    // calculo del interes
                    Pa.CalcularInt();
                ...
                case 2:
                    ...
                    // Creacion del objeto
                    PrestamoHipotecario2 Ph = new PrestamoHipotecario2(numCu,numCli,nombre,capPrest,plazoInv);
                    // calculo del interes
                    Ph.CalcularInt();
                    // Creacion del cadena que almacena datos del reporte final que se imprime
                ...
                case 3:
                    ...
                    // Creacion del objeto metodo constructor
                    PrestamoPersonal2 Pp = new PrestamoPersonal2(numCu,numCli,nombre,capPrest,plazoInv);
                    // calculo del interes
                    Pp.CalcularInt();
                    // Creacion del cadena que almacena datos del reporte final que se imprime
