...
import herenciaAutomotriz.EmpAdmvo;
import herenciaAutomotriz.EmpMecanico;
import herenciaAutomotriz.EmpVendedor;

import java.util.Scanner;

public class EjecutaEmpleado22 {
        ...
        while(opcion <= 4){
            ...
            switch (opcion){
                case 1:
                    ...
                    EmpAdmvo2 empA = new EmpAdmvo2(sueldoM, nombre, dep, puestoA);
                    empA.CalcularSueldoQuin();
                ...
                case 2:
                    ...
                    EmpMecanico2 Mec = new EmpMecanico2(nombreM,dep,puestoM);
                ...
                case 3:
                    ...
                    // Creacion del objeto Mecanico
                    EmpVendedor2 Vend = new EmpVendedor2(nombreV,dep,puestoV);
