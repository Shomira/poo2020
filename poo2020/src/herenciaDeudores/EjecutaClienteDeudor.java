        ...
        while(opcion <= 4){
            ...
            switch (opcion){
                case 1:
                    ...
                    PrestamoAuto Pa = new PrestamoAuto(numCu,numCli,nombre,capPrest,plazoInv);
                    // calculo del interes
                    Pa.calcularIntAuto();
                ...
                case 2:
                    ...
                    // Creacion del objeto
                    PrestamoHipotecario Ph = new PrestamoHipotecario(numCu,numCli,nombre,capPrest,plazoInv);
                    // calculo del interes
                    Ph.calcularIntHi();
                    // Creacion del cadena que almacena datos del reporte final que se imprime
                ...
                case 3:
                    ...
                    // Creacion del objeto metodo constructor
                    PrestamoPersonal Pp = new PrestamoPersonal(numCu,numCli,nombre,capPrest,plazoInv);
                    // calculo del interes
                    Pp.calcularIntPe();
                    // Creacion del cadena que almacena datos del reporte final que se imprime
